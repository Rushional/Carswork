...
//        the expected size is unknown, fill it with data from the tuples
        Map<String, ArrayList<Double>> qualDataMap = new HashMap<String, ArrayList<Double>>();
        ...
        qualDataMap.forEach(new BiConsumer<String, ArrayList<Double>>() {
            @Override
            public void accept(String s, ArrayList<Double> doubles) {
